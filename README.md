# EYE // TAIWAN — Live Flow Map v0.14.0

Zero-Key Taiwan pre-mission intelligence dashboard for Vercel. The primary experience is a MI6/007-inspired black-gold command room: search or speak a destination, then inspect route options, live public CCTV, traffic incidents, freeway flow, weather, speed-enforcement points and related public signals before entering NAV OPS.
...
3. EYE automatically assembles a pre-mission brief, routes, weather, incidents, freeway speeds, CCTV and speed-enforcement information.
